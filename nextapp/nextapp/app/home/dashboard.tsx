...
import { Edit, Trash2, Download, ChevronRight } from 'lucide-react'
        ...
        <div className="flex-1 p-8">
          ...
          <Accordion type="single" collapsible className="w-full" value={`step-${step}`}>
            <AccordionItem value="step-1">
              <AccordionTrigger>Step 1: Upload Resumes</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="step-2">
              <AccordionTrigger>Step 2: Generate Scoring System</AccordionTrigger>
              <AccordionContent>
                <div className="space-y-4">
                  <div>
            ...
            <AccordionItem value="step-3">
              <AccordionTrigger>Step 3: Review and Edit Scoring System</AccordionTrigger>
              <AccordionContent>
                <div className="space-y-4">
